...
if __name__ == "__main__":
    ...
    logo = thorpy.Image.make(thorpy.load_image("../assets/gamelogos/Logo.png"))
    sticky_jump_image = "../assets/gamelogos/StickyJump.png"
    sticky_jump_image_hover = "../assets/gamelogos/StickyJumpHover.png"
    sticky_jam_image = "../assets/gamelogos/StickyJamHover.png"
    reset_image = "../assets/gamelogos/StickyReset.png"
    quit_image = "../assets/gamelogos/Credits.png"
    quit_image_hover = "../assets/gamelogos/CreditsHover.png"
    ...
    background = thorpy.load_image("../assets/gamelogos/white.png")
